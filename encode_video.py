...
ENCODER_SETTINGS = {
    ...
    "AV1_NVENC": {
        ...
        "keyint": 50,
        "maxrate":'6000k',    # Set maximum instantaneous bitrate
        "bufsize":'10000k',    # Set buffer size to control bitrate variability                          # Keyframe interval
                                  # Keyframe interval
    },
    "AV1_Rust": {
...
def encode_video(input_file, output_file,codec,rate=None,max_bit_rate=None):
    """
